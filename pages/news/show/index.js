                ...
                <div className={`${classes.item} ${classes.maincontext}`}>
                    ...
                    <div className={classes.blockNewsMain}>
                        <div className={classes.dtMainList}>
                            <p>05 March 2020</p>
                            <span>Раздел: <Link href="">выставки</Link></span>
                        </div>
                        <div className={classes.newsListMain}>
                            <h2><Link href="#">Металлообработка 2020 – 21-я международная специализированная выставка .</Link></h2>
                    ...
                    <div className={classes.blockNewsMain}>
                        ...
                        <div className={classes.newsListMain}>
                            <h2><Link href="#">27-я Международная специализированная выставка</Link></h2>
